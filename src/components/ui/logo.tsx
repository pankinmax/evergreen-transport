 ...
 *
 * Intrinsic dimensions are declared exactly (995×543 — the asset is trimmed
 * flush to the artwork, no transparent padding), so the mark can never
  ...
  return (
    ...
    >
      <Image
        ...
        height={543}
        priority
        sizes="(max-width: 640px) 100px, (max-width: 1024px) 110px, 130px"
