...
/**
 * Brand/social glyphs. Lucide removed its brand icons in v1, so we ship
 * small, self-contained SVGs here. Each accepts a `className` and inherits
 * the current text colour, matching the Lucide icon API used elsewhere.
 */
...
export function getSocialIcon(name: string) {
  return socialIconMap[name as keyof typeof socialIconMap] ?? FacebookIcon;
}
